...
1) On your download pacakge, you will find theme_eguru.zip

2) Unzip - theme_eguru.zip, you will get folder 'eguru'

3) Copy folder 'eguru' and put into theme folder of your moodle system
...
8) By clicking "Continue" button on success page , you will get options to change the eguru theme settings.
...
5) Then click "Use theme" button on "Eguru theme"
