...
class template_course_renderer extends core_course_renderer {   
    ...
    */
            ...
            foreach ($course->get_course_contacts() as $userid => $coursecontact) {
                $name = $coursecontact['rolename'].': '.
                        html_writer::link(new moodle_url('/user/view.php',
                                array('id' => $userid, 'course' => SITEID, 'sesskey' => $USER->sesskey)),
        ...
        if ($chelper->get_show_courses() == self::COURSECAT_SHOW_COURSES_EXPANDED_WITH_CAT) {
            ...
            if ($cat = coursecat::get($course->category, IGNORE_MISSING)) {
                ...
                $content .= get_string('category').': '.
                        html_writer::link(new moodle_url('/local/template_course/index.php', array('categoryid' => $cat->id)),
    ...
    public function course_section_cm($course, &$completioninfo, cm_info $mod, $sectionreturn, $displayoptions = array()) {
        ...
        $modicons = '';
        if ($this->page->user_is_editing()) {
            $editactions = course_get_cm_edit_actions_reduced($mod, $mod->indent, $sectionreturn);
